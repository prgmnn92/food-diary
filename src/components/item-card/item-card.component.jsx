...
import { Input, InputGroup, InputGroupAddon, Button, Card, CardBody, CardHeader } from 'reactstrap';
			...
			<Card trigger="focus" placement="bottom" target="pop">
				...
				<CardBody>
					...
					<span className="card-row">
						...
						<div className="quantity">{item.nf_serving_weight_grams * faktor} g</div>
					</span>
					<br />

					<InputGroup>
						<Input onChange={(val) => setQuantity(val.target.value)} placeholder="Add in gram" />
						<InputGroupAddon addonType="append">
							<Button onClick={() => addToList(item, Number(quantity))} color="primary">
								Add To List
							</Button>
						</InputGroupAddon>
					</InputGroup>
